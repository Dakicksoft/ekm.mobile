...
namespace Ekm.Mobile.Extensions
{
  public static class StringExtensions
  {
    ...
    public static string Truncate(this string text, int keep)
    {
      ...
      return String.Concat(buffer.Substring(0, keep), "..");
    }
    ...
    public static string ToCustomString(this bool? d)
    {
      string newdate = null;
      if (d != null)
      {
    ...
    public static string RemoveEnterLine(this string text)
    {
    ...
    public static string GetNewRowKey(this string value)
    {
