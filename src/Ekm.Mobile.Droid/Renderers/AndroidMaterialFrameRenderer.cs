...
using Ekm.Mobile.CustomViews;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;
using FrameRenderer = Xamarin.Forms.Platform.Android.AppCompat.FrameRenderer;

[assembly: ExportRenderer(typeof(MaterialFrame), typeof(Ekm.Mobile.Droid.Renderers.AndroidMaterialFrameRenderer))]
namespace Ekm.Mobile.Droid.Renderers
{
    /// <summary>
